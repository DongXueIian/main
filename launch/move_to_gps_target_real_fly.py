...
def generate_launch_description():
    ...
    move_to_gps_target_real_fly_src_dir=os.path.join(move_to_gps_target_real_fly_dir,'..', '..','..','..','src','move_to_gps_target_real_fly')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            move_to_gps_target_real_fly_dir, 'maps', 'empty_world.yaml'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(move_to_gps_target_real_fly_dir, 'params', 'nav2_params.yaml'),
    ...
    # 手动广播静态的scan->footprint转换
    static_tf_pub_scan_to_footprint_cmd = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='static_tf_pub_scan_footprint',
        arguments=['0', '0', '0', '0', '0', '0', 'scan', 'base_footprint'],
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}]
    )

    static_tf_pub_base_link_to_scan_cmd = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='static_tf_pub_base_link_to_scan',
        arguments=['0', '0', '0', '0', '0', '0', 'base_link', 'scan'],
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}]
    )

    sllidar_setup_cmd=IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(move_to_gps_target_real_fly_dir, 'launch','sllidar_a2m8_launch.py')),
